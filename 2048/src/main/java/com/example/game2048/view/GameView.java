...
public class GameView extends GridLayout {
    ...
    public GameView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        initSoundPool();
        gameDatabaseHelper = new GameDatabaseHelper(context, Config.DB_NAME, null, 1);
    }
    ...
    private void startGame() {
        ...
        Cursor cursor = db.query( "G_INFINITE", null, null, null,
                null, null, null);
        if (null != cursor) {
    ...
    private void sendGameOverMsg(String action) {
        ...
        if (GameActivity.newscore) {
            intent.putExtra(KEY_RESULT, "新纪录!");
        } else {
            intent.putExtra(KEY_RESULT, "游戏结束");
        }
        getContext().sendBroadcast(intent);
    }
